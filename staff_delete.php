...
<br>
<br>
<center><h1>Enter Staff Sno to Delete Staff Details</h1></center>
...
<div>
	<form name= "Staffinfo" method="get" action="delete.php">
	<center>Staff Number(Sno):<input type="text" name="sno"><br></center>
