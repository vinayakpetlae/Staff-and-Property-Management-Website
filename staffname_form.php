...
<html>
<head><center><h1>Search Staff Details Based on SNo</h1></center>
...
<br>
<div>
	<form name= "Staffidentify" method="get" action="staff_num.php">
	<center>Staff Number(Sno):<input type="text" name="staffnum"><br></center>
