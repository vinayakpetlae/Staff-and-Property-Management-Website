...
<html>
<head><center><h1>Update Property Rent</h1></center>
...
<br>
<div>
	<form name= "Staffinfo" method="get" action="update_rent.php">
	<center>Property Number:<input type="text" name="Pno"><br></center>
	<center>Property Rent:<input type="text" name="Rent"><br></center>
