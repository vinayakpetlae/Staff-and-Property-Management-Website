...
<html>
<head><center><h1>Search Property City</h1></center>
...
<br>
<div>
	<form name= "Staffidentify" method="get" action="prop_add_num.php">
	<center>Property Number(Ex:PL94):<input type="text" name="staffname"><br></center>
