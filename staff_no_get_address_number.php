...
<html>
<head><center><h1>Search Staff Address</h1></center>
...
<br>
<div>
	<form name= "Staffidentify" method="get" action="staff_add_num.php">
	<center>Staff Name:<input type="text" name="staffname"><br></center>
