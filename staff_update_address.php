...
<html>
<head><center><h1>Update Staff Address</h1></center>
...
<br>
<div>
	<form name= "Staffinfo" method="get" action="update_address.php">
	<center>Staff number:<input type="text" name="sno"><br></center>
	<center>Staff address:<input type="text" name="Newaddress"><br></center>
