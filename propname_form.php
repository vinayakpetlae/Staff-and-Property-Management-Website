...
<html>
<head><center><h1>Search Property Details Based on Pno</h1></center>
...
<br>
<div>
	<form name= "Staffidentify" method="get" action="prop_num.php">
	<center>Property Number(Ex:PL94):<input type="text" name="staffnum"><br></center>
